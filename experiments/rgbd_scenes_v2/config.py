...
# data
_C.data = edict()
_C.data.dataset_dir = "../../data/RGBDScenesV2"
...
# if True, use the coordinate prior for better performance
_C.train.refer_coordinate = True
...
_C.eval.inlier_ratio_threshold = 0.25
_C.eval.rmse_threshold = 0.03
...
if _C.train.refer_coordinate:
    _C.model.image_backbone.input_dim = 4
else:
...
# model - differentiable pnp solver
_C.model.diff_pnp_solver = edict()
_C.model.diff_pnp_solver_type = "bpnp"
_C.model.diff_pnp_solver.translation_loss_weight = 0.1
_C.model.diff_pnp_solver.rotation_loss_weight = 0.5

# _C.model.diff_pnp_solver = None



# model - deformable correspondences
_C.model.deformable_correspondences = edict()
_C.model.deformable_correspondences.pixel_l2_norm_weight = 0.2
_C.model.deformable_correspondences.point_l2_norm_weight = 0.2
_C.model.deformable_correspondences.pixel_residual_weight = 0.4
_C.model.deformable_correspondences.point_residual_weight = 0.4
...
_C.loss.coarse_loss.enable_ms_loss = True
...
_C.loss.sds_loss = edict()
_C.loss.sds_loss.weight = 0.001
